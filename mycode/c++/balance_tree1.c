...
int main(int argc,const char * argv[])
{
        ...
        int value;
        int tmp;
        cout<<"please input some integer ,if input -1 exit:"<<endl;
        while (cin >> value)
        {
                if (value == -1)
                        break;
        ...
        cout << "\nplease input find data:";
        cin >> tmp;
        if (tree.Contains(tree.root, tmp))
                cout << "find" << endl;
        else
        cout << "value=" << tmp << "node not exists" << endl;
        cout << "please input delete node data:";
        cin >> tmp;
        tree.Delete(tree.root, tmp);
        cout << "InorderTraversal after delete:";
        tree.InorderTraversal(tree.root);
        cout << "\nPreorderTraversal after delete:";
        tree.PreorderTraversal(tree.root);
        printf("\n");
        return 0;
}
